...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0003_user_is_online_user_last_seen'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='message',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='api.groupchat'),
        ),
    ]
